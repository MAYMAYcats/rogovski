  ...
  <section id="footer">
    <div className="footerContainer">
      <div className="leftContainer">
        <h2>03-6274-6670</h2>
        <p>
          Please contact the store for details on closing days for the New Year 
        ...
        <div className="weekends">
          ...
          <p>Lunch | 11:00 - 16:00 (LO.15:00)</p>
          <p>Dinner | 16:00 - 22:00 (LO.21:00)</p>
        </div>
      </div>
      <div className="midContainer">
        <ul>
          ...
          <li>News</li>
          <li>Access</li>
          <li className="onlineShop">Online Shop</li>
          <li className="reserveBtn">Reserve</li>
